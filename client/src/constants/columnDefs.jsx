...
export const SONGS_MANAGEMENT_COLUMN_DEFS = [
    {
        title: (
    ...
    {
        title: (
            <div className="flex items-center justify-center">Release date</div>
        ),
