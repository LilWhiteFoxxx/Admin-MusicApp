...
const SongsManagement = lazy(() => import("@pages/SongsManagement"));
const ArtistsGrid = lazy(() => import("@pages/ArtistsGrid"));
const AlbumsGrid = lazy(() => import("@pages/AlbumsGrid"));
    ...
    return (
        <SidebarProvider>
            <ThemeProvider theme={{ theme: theme }}>
                ...
                <div
                    className={`app ${!withSidebar ? "fluid" : ""}`}
                    ref={appRef}
                >
                    <ScrollToTop />
                    {withSidebar && <Sidebar />}
